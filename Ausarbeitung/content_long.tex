...
\item[Update()] Der interne Zustand der Spielwelt und ihrer Objekte wird aktualisiert, bspw. die Position der Spielfigur gemaess der Benutzereingaben angepasst oder das nächste Frame in einer Animation wird ausgewählt oder die Punktzahl erhöht. Zeitgleich finden hier auch komplexere Berechnungen statt, wie die Kollisionsbestimmung, die wieder zu neuen Berechnungen fuehren kann (Positionen werden angepasst, damit Objekte sich nicht ueberlagern; "Gesundheitswerte" werden bei Treffern verringert)
