...
2D-Frameworks sind eine Spezialisierung von Game-Frameworks. Diese sollen den Entwickler beim Implementieren der Game Loop, bestehend aus den Phasen \emph{Update} und \emph{Draw}, unterstützen. Hierbei stellt das Framework ofts bereits eigene, und optimierte Klassen für Texturen, Audio-Dateien u.a. bereit.\\
