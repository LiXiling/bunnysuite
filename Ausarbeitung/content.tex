...
\begin{figure}[!tbp]
  \centering
  \subfloat[Unterschreiten von 56 FPS.]{\includegraphics[width=0.4\textwidth]{bar_chart.png}\label{dia:bar}}
  \hfill
  \subfloat[Renderzeit pro Anzahl Objekte.]{\includegraphics[width=0.4\textwidth]{line_graph.png}\label{dia:line}}
