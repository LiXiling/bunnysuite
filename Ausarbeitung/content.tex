...
\begin{center}
    ...
    \hline
animation     & n Objekte werden in die linke obere Ecke gezeichnet und mitzufälliger Geschwindigkeit in X und Y Richtung initialisiert. Mit jedem Frame wird die Position jedes Objektes mit seiner Geschwindigkeit neu berechnet. Die Y Geschwindigkeit wird zusätzlich durch "Schwerkraft" in jedem Frame beeinflusst. Wenn die Ränder des Frames erreicht werden, wird die Richtung umgekehrt. Dies führt zum Eindruck einer Hüpf-Animation für die Objekte. 
\\ \hline
alpha         & Zusaetzlich zu den vorhandenen Texturen wird die Textur "wabbit\_ghost" hinzugefuegt. Diese Textur zeichnet sich durch ihre Halbtransparenz aus.                                                                                                                                                                                                                                                                                                \\ \hline
circles       & Anstelle von texturierten Bunnies, wird das Primitv "Kreis" mit Radius 13px gezeichnet.                                                                                                                                                                                                                                                                                                                                                         \\ \hline
hdtexture     & Zusätzlich zu den vorhandenen Texturen wird die Textur wabbit\_hd zum Texturenpool hinzugefuegt. Diese Textur ist sehr hoch aufgeloest. Die Bunnies werden daher am Anfang auf die Hoehe von 37px runterskaliert.
\\ \hline
lines         & Anstelle von texturierten Bunnies, wird das Primitv "Linie" mit den Punkten (0,0) und (26,37) gezeichnet.                                                                                                                                                                                                                                                                                                                                       \\ \hline
multitexture  & Zusätzlich zu den vorhandenen Texturen werden die Texturen wabbit\_1 und wabbit\_2 zum Texturenpool hinzugefügt.                                                                                                                                                                                                                                                                                                                                \\ \hline
no\_output    & Es findet keine Ausgabe an den Bildschirm statt. Saemtliche Zustandsberechnungen aus der Update-Phase werden entsprechend der restlichen Testparameter normal ausgefuehrt.                                                                                                                                                                                                                                                                      \\ \hline
random        & Die Bunnies werden am Anfang an eine zufällige Stelle gesetzt.                                                                                                                                                                                                                                                                                                                                                                                  \\ \hline
rectangle     & Anstelle von texturierten Bunnies, wird das Primitv "Rechteck" mit den Punkten (0,0) und (26,37) gezeichnet.                                                                                                                                                                                                                                                                                                                                    \\ \hline
pulsation     & Mit jedem Frame wird die Skalierung um ein "Wachstum" verändert (initial 0.1). Immer wenn die Skalierung \textgreater= 5 oder \textless= 0.2 ist, wird das Wachstum mit -1 multipliziert. Somit scheinen die Objekte zwischen den beiden Groessenextremen hin und her zu pulsieren.                                                                                                                                                             \\ \hline
scaled        & Die Bunnies werden am Anfang mit einem zufälligen Faktor zwischen 0.2 und 5.0 skaliert (x- und y-Achse unabhängig)                                                                                                                                                                                                                                                                                                                              \\ \hline
teleport      & Die Bunnies werden in jedem Frame an neue zufällige Stellen gezeichnet.                                                                                                                                                                                                                                                                                                                                                                         \\ \hline
texts         & Anstelle von texturierten Bunnies, wird der Text "Hello World!" gerendert.                                                                                                                                                                                                                                                                                                                                                                      \\ \hline
texturechange & Mit jedem neuem Frame bekommt jeder Bunny eine neue zufällige Textur aus dem Texturenpool zugewiesen.                                                                                                                                                                                                                                                                                                                                           \\ \hline
thin          & Zusätzlich zu den vorhandenen Texturen wird die Textur wabbit\_y hinzugefügt, die nicht einer Rechteck-Annaeherung entspricht und damit viel Voll-Transparenz aufweist.                                                                                                                                                                                                                                                                         \\ \hline
triangle      & Anstelle von texturierten Bunnies, wird das Primitv "Dreieck" mit den Punkten (0,37), (26,37), und (13,0) gezeichnet.                                                                                                                                                                                                                                                                                                                           \\ \hline
\end{tabular}
\end{center}
