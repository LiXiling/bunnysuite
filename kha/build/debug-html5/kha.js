...
BunnyMark.prototype = {
	...
	,render: function(framebuffer) {
		...
		g.begin(null,BunnyMark.bgColor);
		this.bunny.render(g);
		g.end();
...
Main.__name__ = true;
Main.main = function() {
	kha_System.init("BunnyMark",1024,768,function() {
		new BunnyMark();
	});
};
Math.__name__ = true;
...
var kha_ImageList = function() {
	this.wabbit_alpha2Description = { files : ["wabbit_alpha2.png"], original_height : 37, type : "image", original_width : 26, name : "wabbit_alpha2"};
	this.wabbit_alpha2Name = "wabbit_alpha2";
	this.wabbit_alpha2 = null;
	this.wabbit_alpha1Description = { files : ["wabbit_alpha1.png"], original_height : 37, type : "image", original_width : 26, name : "wabbit_alpha1"};
	this.wabbit_alpha1Name = "wabbit_alpha1";
	this.wabbit_alpha1 = null;
	this.wabbit_alpha0Description = { files : ["wabbit_alpha0.png"], original_height : 37, type : "image", original_width : 26, name : "wabbit_alpha0"};
	this.wabbit_alpha0Name = "wabbit_alpha0";
	this.wabbit_alpha0 = null;
};
$hxClasses["kha.ImageList"] = kha_ImageList;
kha_ImageList.__name__ = true;
kha_ImageList.prototype = {
	wabbit_alpha0: null
	,wabbit_alpha0Name: null
	,wabbit_alpha0Description: null
	,wabbit_alpha0Load: function(done) {
		kha_Assets.loadImage("wabbit_alpha0",function(image) {
			done();
		});
	}
	,wabbit_alpha0Unload: function() {
		this.wabbit_alpha0.unload();
		this.wabbit_alpha0 = null;
	}
	,wabbit_alpha1: null
	,wabbit_alpha1Name: null
	,wabbit_alpha1Description: null
	,wabbit_alpha1Load: function(done) {
		kha_Assets.loadImage("wabbit_alpha1",function(image) {
			done();
		});
	}
	,wabbit_alpha1Unload: function() {
		this.wabbit_alpha1.unload();
		this.wabbit_alpha1 = null;
	}
	,wabbit_alpha2: null
	,wabbit_alpha2Name: null
	,wabbit_alpha2Description: null
	,wabbit_alpha2Load: function(done) {
		kha_Assets.loadImage("wabbit_alpha2",function(image) {
			done();
		});
	}
	,wabbit_alpha2Unload: function() {
		this.wabbit_alpha2.unload();
		this.wabbit_alpha2 = null;
	}
...
kha_LoaderImpl.loadBlobFromDescription = function(desc,done) {
	...
	fs.readFile(path.join(app.getAppPath(),desc.files[0]),function(err,data) {
		...
		var bytes = haxe_io_Bytes.alloc(byteArray.byteLength);
		var _g1 = 0;
...
kha_SystemImpl.loadFinished = function() {
	...
	try {
		...
		if (e instanceof js__$Boot_HaxeError) e = e.val;
		haxe_Log.trace(e,{ fileName : "SystemImpl.hx", lineNumber : 204, className : "kha.SystemImpl", methodName : "loadFinished"});
	}
...
kha_audio2_ogg_vorbis_VorbisDecodeState.prototype = {
	...
	,next: function() {
		...
		if(!(this.bytesInSeg == 0)) throw new js__$Boot_HaxeError(new kha_audio2_ogg_vorbis_data_ReaderError(kha_audio2_ogg_vorbis_data_ReaderErrorType.OTHER,"",{ fileName : "VorbisDecodeState.hx", lineNumber : 184, className : "kha.audio2.ogg.vorbis.VorbisDecodeState", methodName : "next"}));
		this.bytesInSeg = len;
		return len;
	}
	...
	,analyzePage: function(seekFunc,h) {
		...
		if(!(pageHeader[0] == 79 && pageHeader[1] == 103 && pageHeader[2] == 103 && pageHeader[3] == 83)) throw new js__$Boot_HaxeError(new kha_audio2_ogg_vorbis_data_ReaderError(kha_audio2_ogg_vorbis_data_ReaderErrorType.OTHER,"",{ fileName : "VorbisDecodeState.hx", lineNumber : 660, className : "kha.audio2.ogg.vorbis.VorbisDecodeState", methodName : "analyzePage"}));
	...
	,decodeScalarRaw: function(c) {
		this.prepHuffman();
		if(!(c.sortedCodewords != null || c.codewords != null)) throw new js__$Boot_HaxeError(new kha_audio2_ogg_vorbis_data_ReaderError(kha_audio2_ogg_vorbis_data_ReaderErrorType.OTHER,"",{ fileName : "VorbisDecodeState.hx", lineNumber : 787, className : "kha.audio2.ogg.vorbis.VorbisDecodeState", methodName : "decodeScalarRaw"}));
		...
		if(!(!c.sparse)) throw new js__$Boot_HaxeError(new kha_audio2_ogg_vorbis_data_ReaderError(kha_audio2_ogg_vorbis_data_ReaderErrorType.OTHER,"",{ fileName : "VorbisDecodeState.hx", lineNumber : 829, className : "kha.audio2.ogg.vorbis.VorbisDecodeState", methodName : "decodeScalarRaw"}));
		var _g1 = 0;
		var _g = c.entries;
		while(_g1 < _g) {
			var i = _g1++;
...
kha_audio2_ogg_vorbis_VorbisDecoder.prototype = {
	...
	,getWindow: function(len) {
		len <<= 1;
		if(len == this.header.blocksize0) return this.window[0]; else if(len == this.header.blocksize1) return this.window[1]; else {
...
kha_audio2_ogg_vorbis_VorbisTools.assert = function(b,p) {
	if(!b) throw new js__$Boot_HaxeError(new kha_audio2_ogg_vorbis_data_ReaderError(kha_audio2_ogg_vorbis_data_ReaderErrorType.OTHER,"",p));
};
...
kha_audio2_ogg_vorbis_data_Codebook.prototype = {
	...
	,includeInSort: function(len) {
		if(this.sparse) {
			if(!(len != 255)) throw new js__$Boot_HaxeError(new kha_audio2_ogg_vorbis_data_ReaderError(kha_audio2_ogg_vorbis_data_ReaderErrorType.OTHER,"",{ fileName : "Codebook.hx", lineNumber : 201, className : "kha.audio2.ogg.vorbis.data.Codebook", methodName : "includeInSort"}));
			return true;
		} else if(len == 255) return false; else if(len > 10) return true; else return false;
	}
	,computeCodewords: function(len,n,values) {
		...
		if(k == n) {
			if(!(this.sortedEntries == 0)) throw new js__$Boot_HaxeError(new kha_audio2_ogg_vorbis_data_ReaderError(kha_audio2_ogg_vorbis_data_ReaderErrorType.OTHER,"",{ fileName : "Codebook.hx", lineNumber : 228, className : "kha.audio2.ogg.vorbis.data.Codebook", methodName : "computeCodewords"}));
			return true;
		}
		var m = 0;
		...
		while(++i < n) {
			...
			if(z != len[i]) {
				var y = len[i];
				while(y > z) {
					if(!(available[y] == 0)) throw new js__$Boot_HaxeError(new kha_audio2_ogg_vorbis_data_ReaderError(kha_audio2_ogg_vorbis_data_ReaderErrorType.OTHER,"",{ fileName : "Codebook.hx", lineNumber : 272, className : "kha.audio2.ogg.vorbis.data.Codebook", methodName : "computeCodewords"}));
	...
	,computeSortedHuffman: function(lengths,values) {
		if(!this.sparse) {
			...
			if(!(k == this.sortedEntries)) throw new js__$Boot_HaxeError(new kha_audio2_ogg_vorbis_data_ReaderError(kha_audio2_ogg_vorbis_data_ReaderErrorType.OTHER,"",{ fileName : "Codebook.hx", lineNumber : 296, className : "kha.audio2.ogg.vorbis.data.Codebook", methodName : "computeSortedHuffman"}));
		} else {
			var _g11 = 0;
		...
		while(_g3 < len) {
			...
			if(this.sparse?(function($this) {
				var $r;
				if(!(huffLen != 255)) throw new js__$Boot_HaxeError(new kha_audio2_ogg_vorbis_data_ReaderError(kha_audio2_ogg_vorbis_data_ReaderErrorType.OTHER,"",{ fileName : "Codebook.hx", lineNumber : 201, className : "kha.audio2.ogg.vorbis.data.Codebook", methodName : "includeInSort"}));
				$r = true;
				return $r;
			}(this)):huffLen == 255?false:huffLen > 10?true:false) {
...
BunnyMark.bgColor = kha__$Color_Color_$Impl_$._new(0);
BunnyMark.screenWidth = 1024;
BunnyMark.screenHeight = 768;
